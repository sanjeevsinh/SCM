...
namespace SCM.Migrations
{
    ...
    [Migration("20170316104143_Update8")]
            ...
            modelBuilder.Entity("SCM.Models.MultiPort", b =>
                {
                    ...
                    b.Property<string>("BgpPeerSourceIpAddress");
            ...
            modelBuilder.Entity("SCM.Models.RouteTarget", b =>
                {
                    ...
                    b.Property<int?>("RouteTargetRangeID1");
                    ...
                    b.HasIndex("RouteTargetRangeID1");
            ...
            modelBuilder.Entity("SCM.Models.Vrf", b =>
                {
                    ...
                    b.Property<int?>("RouteDistinguisherRangeID1");
                    ...
                    b.HasIndex("RouteDistinguisherRangeID1");
            ...
            modelBuilder.Entity("SCM.Models.RouteTarget", b =>
                {
                    ...
                    b.HasOne("SCM.Models.RouteTargetRange")
                        .WithMany("RouteTargets")
                        .HasForeignKey("RouteTargetRangeID1");
            ...
            modelBuilder.Entity("SCM.Models.Vrf", b =>
                {
                    ...
                    b.HasOne("SCM.Models.RouteDistinguisherRange")
                        .WithMany("Vrfs")
                        .HasForeignKey("RouteDistinguisherRangeID1");
