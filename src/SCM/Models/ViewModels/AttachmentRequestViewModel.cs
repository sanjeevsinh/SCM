...
{
    public class AttachmentRequestViewModel
    {
        public int ID { get; set; }
        public string PortType { get; set; }
        public string PortName { get; set; }
        [Required(AllowEmptyStrings = false, ErrorMessage = "A VFF name must be specified")]
        ...
        [Required(ErrorMessage = "A bandwidth must be selected")]
